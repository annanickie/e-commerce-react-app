                    ...
                    <table className="w-full text-left border border-collapse sm:border-separate border-red-100 text-red-400">
                        <tbody>
                            <tr>
                                ...
                                <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-red-100 text-slate-700 bg-slate-100">
                                    Order Id
                                </th>
                                    ...
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        return (
                                            <tr key={index} className="text-red-300">
                                                ...
                                                <td onClick={() => orderDelete(order.id)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-red-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
                                                    Delete
                                                </td>
                                            </tr>
                                        );
