                ...
                <div className="mid mb-5">
                    ...
                    <div className="bg-red-50 py-5 rounded-xl border border-red-100">
                        ...
                        <div className="flex justify-center">
                            <img src="/images/6833605.png" alt="img" className="h-20 w-20"/>
                        </div>
                        {/* text  */}
                           <div className="">
                            {/* Name  */}
                        ...
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className="border bg-red-50 hover:bg-red-100 border-red-100 px-4 py-3 rounded-xl">
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-red-400"> {getAllProduct.length}</h2>
                            ...
                            <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                                <div className="border bg-red-50 hover:bg-red-100 border-red-100 px-4 py-3 rounded-xl">
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-red-400">{getAllOrder.length}</h2>
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className="border bg-red-50 hover:bg-red-100 border-red-100 px-4 py-3 rounded-xl">
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-red-400">{getAllUser.length}</h2>
